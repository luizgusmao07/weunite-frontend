import {
  Home, Search as SearchIcon, Link, MessageCircleMore, DiamondPlus, LogOut, User, Settings, Moon,
  Sun
} from "lucide-react";
...
export function LeftSidebar() {
  ...
  const CustomSidebarTrigger = (props: React.ComponentProps<typeof SidebarTrigger>) => {
